...
--
-- Host: 127.0.0.1
-- Tempo de geração: 16/11/2023 às 20:33
...
CREATE TABLE IF NOT EXISTS `admin` (
  ...
  `data_itme_cadastro` datetime NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`)
...
INSERT INTO `admin` (`id`, `nome`, `login`, `senha`, `ativo`, `data_itme_cadastro`) VALUES
...
(5, 'Projeto 3', 'projeto3', 'imovel', '', 1, 0),
